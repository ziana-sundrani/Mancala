...
- List the four core concepts, the features they implement, and why each feature
  ...
  the application, I used a File I/O Buffered File Writer to save state of the array and the player whose turn it was.
  ...
  the board prevented changing the game state, and that there was proper encapsualtion.

=========================
=: Your Implementation :=
=========================

- overview of each of the classes in the code, and what their
